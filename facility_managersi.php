...
if ($_SERVER['REQUEST_METHOD'] === 'GET' && isset($_GET['delete_id'])) {
    ...
    if ($connection->query($delete_sql) === TRUE) {
        header("Location: facility_managersi.php"); // Refresh the page
        exit();
    } else {
    ...
    if ($result->num_rows > 0) {
        while ($row = $result->fetch_assoc()) {
            ...
            echo "<tr class='$school_class'>
                ...
                <td>
                    <form action='facility_managersi.php' method='get' onsubmit='return confirm(\"Are you sure you want to delete this record?\");'>
...
<a href="facility_managers.php">View Student List</a>
