...
<?php
// Additional Secure CRUD 3: Facility Manager - Update Inventory Assignments

// Ensure only Facility Managers can update inventory
if (!isset($_SESSION['role']) || $_SESSION['role'] !== 'facility manager') {
    die("Unauthorized access.");
}

// UPDATE: Modify Inventory Assignments (Without modifying existing code)
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['update_inventory'])) {
    ...
    $valid_statuses = ["Assigned", "In-Use", "Returned"];
    ...
    if ($stmt->execute()) {
        echo "Inventory assignment updated successfully.";
    } else {
